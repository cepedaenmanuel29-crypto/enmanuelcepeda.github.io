...
/*
// This demonstrates an object literal.
window.onload = function() {
  const tempPt1 = {x: 5, y: 6};
...
class Point {
  ...
  #x;  // point's x-axis value
  #y;  // point's y-axis value
  ...
  static distance(pt1, pt2) {
    ...
    var distance = null; // distance apart with direct connection
